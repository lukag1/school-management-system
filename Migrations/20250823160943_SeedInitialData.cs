    ...
    public partial class SeedInitialData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NastavnikPredmeti", x => new { x.NastavnikId, x.PredmetId });
                    table.ForeignKey(
                        name: "FK_NastavnikPredmeti_Predmeti_PredmetId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ocene_AspNetUsers_NastavnikId",
                        column: x => x.NastavnikId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ocene_AspNetUsers_UcenikId",
                        column: x => x.UcenikId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NastavnikPredmeti_PredmetId",
                table: "NastavnikPredmeti",
                column: "PredmetId");

            migrationBuilder.CreateIndex(
                name: "IX_Ocene_NastavnikId",
                table: "Ocene",
                column: "NastavnikId");
